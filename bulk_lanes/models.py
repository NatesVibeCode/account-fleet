...
SCHEMA_BASE = "https://raw.githubusercontent.com/NatesVibeCode/bulk-lanes/master/schemas"
...
class TaskSpec(ClosedModel):
    ...
    format_version: Literal["bulk_lanes_task_v1"] = "bulk_lanes_task_v1"
...
class CleanPacket(ClosedModel):
    ...
    format_version: Literal["bulk_lanes_v2"] = "bulk_lanes_v2"
    exported_at: str
